...
def get_high_low_life_data():
    life_data = get_life_expectancy()
...
def compiled_best_worst():
  ...
  state_counts_bad = bad_dfs['LocationDesc'].value_counts()
  state_counts_good = good_dfs['LocationDesc'].value_counts()
